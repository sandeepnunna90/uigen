                ...
                <div className="h-14 border-b border-neutral-200/60 px-6 flex items-center justify-between bg-neutral-50/50">
                  ...
                  >
                    <TabsList
                      ...
                      onPointerDown={() => {
                        // When the preview iframe has focus, clicking outside it requires
                        // two clicks in some browsers — first to return focus, then to click.
                        // Blurring the active iframe element first ensures the tab click registers.
